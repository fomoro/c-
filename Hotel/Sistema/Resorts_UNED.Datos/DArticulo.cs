...
namespace Resorts_UNED.Datos
{
    public class DArticulo
    {
        ...
        public DataTable ObtenerConCategoria()
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("Articulos_ObtenerConCategoria", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                SqlCon.Open();
                Resultado = Comando.ExecuteReader();
                Tabla.Load(Resultado);
        ...
        public DataTable ObtenerPorHotel(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("Articulos_ObtenerPorHotel", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public DataTable BuscarConCategoria(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("Articulo_BuscarConCategoria", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@valor", SqlDbType.VarChar).Value = Valor;
                SqlCon.Open();
                Resultado = Comando.ExecuteReader();
