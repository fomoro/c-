...
{
    public class NAsignacionArticuloHotel
    {
        private Datos.DAsignacionArticuloHotel datosAsignacion;

        public NAsignacionArticuloHotel()
        {
            this.datosAsignacion = new Datos.DAsignacionArticuloHotel();
        }
